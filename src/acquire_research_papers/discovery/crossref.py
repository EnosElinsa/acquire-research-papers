...
class CrossrefClient:
    ...
    def _candidate(item: dict[str, Any], query_url: str) -> CandidateMetadata:
        ...
        return CandidateMetadata(
            ...
            provenance={"source": "crossref", "query_url": query_url},
        )
    ...
    def search(
        ...
        *,
        ...
        parameters: list[tuple[str, str]] = [
            ...
            (
                "select",
                "DOI,title,author,published,container-title,publisher,type,URL,resource,abstract,score,is-referenced-by-count",
            ),
        ]
        if filters:
            parameters.append(
